...
def deteksi_bentuk(cnt):
    ...
    # Parameter 0.04 * peri adalah epsilon, semakin kecil semakin akurat
    approx = cv2.approxPolyDP(cnt, 0.03 * peri, True) # Mengurangi epsilon untuk akurasi lebih baik
...
def prediksi_fungsi(warna, bentuk):
    ...
    if warna == "Merah" and bentuk == "Lingkaran":
        ...
        return "LURUS / UMUM"
    elif warna == "Biru" and "Panah" in bentuk: # Memastikan deteksi panah lebih fleksibel
        return "ARAH (BELOK/PUTAR)"
    elif warna == "Biru":
        return "PETUNJUK"
    elif warna == "Kuning" and bentuk == "Segitiga":
        return "PERINGATAN"
    else:
        return "Tidak diketahui"
